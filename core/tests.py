...
class DashboardTests(TestCase):
    ...
    def test_participant_dashboard_redirects_to_canonical_personal_space(self):
        ...
        self.assertContains(personal, "Moi")
        ...
        self.assertContains(personal, 'hx-select-oob="#app-topbar:outerHTML,#desktop-sidebar:outerHTML,#mobile-primary-nav:outerHTML"', html=False)
