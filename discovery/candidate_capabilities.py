...
OCCURRENCE_FILTER_CAPABILITIES = CandidateFilterCapabilities(
    ...
    supported_filters=frozenset(
        {"q", "place", "when", "period", "vertical", "price", "proximity", "date", "date_from", "date_to", "ordering", "timezone"}
    ),
)
...
FUNDING_FILTER_CAPABILITIES = CandidateFilterCapabilities(
...
FAMILY_FILTER_CAPABILITIES = {
    ...
    "funding_activity": FUNDING_FILTER_CAPABILITIES,
