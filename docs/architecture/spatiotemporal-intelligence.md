...
Les hazards ont une clé stable, une classe INTERNAL/EXTERNAL, une severity, une audience, une source et une fraîcheur. Les hazards expirés sont filtrés.
...
M5 reste l’unique moteur de recommandations Activity-first. M6 lui fournit seulement des reason codes/candidates.
...
Le Journey detail consomme la projection M6 et propose l’itinéraire destination-only sans demander automatiquement la géolocalisation. Le generic Activity detail peut afficher le contexte public d’Occurrence.
