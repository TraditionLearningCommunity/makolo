...
class DomainEventType:
    ...
    CONVERSATION_POINT_PUBLISHED = "conversation.point.published"
    CONVERSATION_POINT_RESPONSE_CLOSED = "conversation.point.response_closed"
    CONVERSATION_POINT_RESOLVED = "conversation.point.resolved"
    CONVERSATION_POINT_EXPIRED = "conversation.point.expired"
    CONVERSATION_POINT_CANCELLED = "conversation.point.cancelled"
    CONVERSATION_POINT_SUPERSEDED = "conversation.point.superseded"
    CONVERSATION_INVITATION_CREATED = "conversation.invitation.created"
    CONVERSATION_INVITATION_ACCEPTED = "conversation.invitation.accepted"
    CONVERSATION_INVITATION_DECLINED = "conversation.invitation.declined"
    CONVERSATION_ROUTE_ADDED = "conversation.route.added"
    CONVERSATION_ROUTE_RETIRED = "conversation.route.retired"
