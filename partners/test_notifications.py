...
class PartnerNotificationTests(TestCase):
    def setUp(self):
        self.owner = User.objects.create_user(username="notify-partner-owner", email="notify-owner@example.com", password="Strong-password-2026!")
        self.finance = User.objects.create_user(username="notify-partner-finance", email="notify-finance@example.com", password="Strong-password-2026!")
        self.ambassador = User.objects.create_user(username="notify-ambassador", email="notify-ambassador@example.com", password="Strong-password-2026!")
        self.buyer = User.objects.create_user(username="notify-affiliate-buyer", email="notify-buyer@example.com", password="Strong-password-2026!")
