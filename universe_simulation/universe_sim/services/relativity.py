...
def metrique_trou_noir_parametrique(masse_kg: float, spin_dimensionnel: float = 0.0) -> Metrique4D:
    """Return an horizon-penetrating prescribed metric for an uncharged BH."""
...
def metrique_pour_trou_noir(trou_noir: "TrouNoir") -> Metrique4D:
    return metrique_trou_noir_parametrique(trou_noir.masse().value, trou_noir.parametre_spin())
